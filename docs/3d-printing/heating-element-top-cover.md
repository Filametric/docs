...
|---|---|
| Flow ratio | **0.864** |
| Bed temperature (initial + other layers) | **40 째C** |
| Nozzle temperature (initial + other layers) | **280 째C** |
...
!!! note "Printer-specific settings"
    The flow ratio of **0.864** was calibrated on a Bambu Lab H2S and may vary depending on your printer. The bed temperature of **40 캜** is specifically tuned for Fiberon's warp-free technology. Other PA6-GF variants may require different flow ratios and bed temperatures. Always calibrate for your setup.
...
![Sliced result](../images/3d-printing/heating-element-top-cover-sliced.webp)
